...
import { formatDate, formatDistanceToNow } from "@/src/lib/date-utils";
...
export default function DashboardView({ insights }) {
  ...
  const lastUpdatedDate = formatDate(insights.lastUpdated, "dd/MM/yyyy");
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{Number(insights.growthRate).toFixed(1)}%</div>
            <Progress value={Number(insights.growthRate)} className="mt-2" />
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className={`mt-2 h-2 w-full rounded-full ${getDemandLevelColor(insights.demandLevel)}`} />
          </CardContent>
        </Card>
